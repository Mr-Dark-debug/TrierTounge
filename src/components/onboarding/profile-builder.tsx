...
export function ProfileBuilder({ user, onComplete, onLogout }: ProfileBuilderProps) {
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8 flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full flex-1 flex flex-col pb-24">
              ...
              <div className="space-y-6">
                <div className="neo-card p-4 md:p-8 bg-white space-y-6">
                  ...
                  <div className="flex items-center gap-4 pt-4 border-t-2 border-black">
                    ...
                    />
                    <Label className="font-bold text-xs md:sm">Reveal handles only after mutual match acceptance.</Label>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Button
        ...
        onClick={prevStep}
        disabled={step === 1}
        className="fixed bottom-4 left-4 md:bottom-8 md:left-8 neo-button bg-white disabled:opacity-50 h-10 md:h-12 text-xs md:text-sm px-4 md:px-6 z-50 shadow-neo"
      >
      ...
      {step < 6 ? (
        <Button
          ...
          className="fixed bottom-4 right-4 md:bottom-8 md:right-8 neo-button min-w-[100px] md:min-w-[120px] h-10 md:h-12 text-xs md:text-sm px-4 md:px-6 z-50 shadow-neo"
        >
        ...
        <Button
          ...
          className="fixed bottom-4 right-4 md:bottom-8 md:right-8 neo-button bg-accent min-w-[100px] md:min-w-[120px] h-10 md:h-12 text-xs md:text-sm px-4 md:px-6 z-50 shadow-neo"
        >
